...
public partial class cms_admin_SanPham_QuanLySanPham_SanPham_ThemMoi : System.Web.UI.UserControl
{
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        if (thaotac == "ThemMoi")
        {
            ...
            mypham.SanPham.Sanpham_Inser(tbTenSanPham.Text, flAnhDaiDien.FileName, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text, tbNgayTao.Text, tbNgayHuy.Text, ddlDanhMucCha.SelectedValue, ddlNhom.SelectedValue, "");
        ...
        else
        {
            ...
            mypham.SanPham.Sanpham_Update(id,tbTenSanPham.Text, tenAnhDaiDien, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text,
