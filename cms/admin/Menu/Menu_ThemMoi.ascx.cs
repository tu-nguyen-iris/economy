...
public partial class cms_admin_Menu_Menu_ThemMoi : System.Web.UI.UserControl
{
    ...
    private void HienThiThongTin(string id)
    {
        if(thaotac=="ChinhSua")
        {
            ...
            dt = mypham.Menu.Thongtin_Menu_by_id(id);
            if(dt.Rows.Count>0)
            {
    ...
    {
        DataTable dt = new DataTable();
        dt = mypham.Menu.Thongtin_Menu_by_MaMenuCha(MaMenuCha);
    ...
    protected void btThemMoi_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            mypham.Menu.Menu_Update(id, tbTenMenu.Text, tbLienKet.Text,
                ddlMenuCha.SelectedValue, tbThuTu.Text);
