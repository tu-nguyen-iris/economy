        ...
        <div class="ttct">
            <div class="dienThongTinDatHang">
             ...
             <label for="formGroupExampleInput">Họ tên (*):</label>
                 <input id="tbHoTen" type="text" value="<%=hoTen %>" class="form-control" >
                 </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2">Địa chỉ:</label>
                    <input type="text" class="form-control" id="tbDiaChi" type="text" value="<%=diaChi %>" >
                  </div>
                    <div class="form-group">
                    <label for="formGroupExampleInput2">Số điện thoại (*):</label>
                    <input type="number" class="form-control" id="tbSoDienThoai" type="text" value="<%=soDienThoai %>" >
                  </div>
                       <div class="form-group">
                    <label for="formGroupExampleInput2">Email: (*):</label>
                    <input type="email" class="form-control" id="tbEmail" type="text" value="<%=email %>" >
                  </div>
          ...
          <div class="CacHinhThucThanhToan">
                ...
                <div>                    
                    ...
                    <div class="paymentInfo">
                        Tên tài khoản: Abcd<br/>
                        Số tài khoản: 1234565<br/>
